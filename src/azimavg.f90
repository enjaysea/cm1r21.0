...
! 217    format(2x,f13.6)
 ...
 111    format('endvars')
  ...
  ENDDO  bigwloop
    ...
    call MPI_ALLREDUCE(MPI_IN_PLACE,savg,icrs*(nk+1),MPI_DOUBLE_PRECISION,MPI_MAX,MPI_COMM_WORLD,ierr)
    ...
    call MPI_ALLREDUCE(MPI_IN_PLACE,savg,icrs*(nk+1),MPI_DOUBLE_PRECISION,MPI_MIN,MPI_COMM_WORLD,ierr)
